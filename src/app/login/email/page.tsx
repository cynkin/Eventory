        ...
        <div className="flex justify-center items-center">
            <div className="w-[460px]">
                <div className="flex flex-col items-center ">
                    ...
                    <button onClick={googleLogin} className=" transition-all duration-200 hover:bg-[#0d4eaf] flex items-center tracking-wide w-full bg-[#1568e3] rounded-lg pl-2 pr-9 py-2 text-white text-lg mt-10">
